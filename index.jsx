...
const styles = `
  ...
  .animate-lock { animation: chain-lock 0.4s ease-out forwards; }
  ...
  @keyframes shrink-out {
    0% { transform: scale(1); opacity: 1; filter: brightness(2); background-color: white; }
    100% { transform: scale(0); opacity: 0; }
  }
  .animate-clearing { animation: shrink-out 0.8s forwards; }
  ...
  .animate-float-score { animation: float-up 1s ease-out forwards; }
`;
